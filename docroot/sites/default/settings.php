 ...
 * @endcode
 */
$settings['hash_salt'] = 'oijvPGjdAODtTab5LNpkHwcH3Nx0Eb8QkWf_MhC8DxfLvyk4O-AnFtoDIwmYIi-rRBv9obgWLg';
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_drupalsk_dd.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_drupalsk_dd.inc';
}
// </DDSETTINGS>
